...
public class FileProcessor : IFileProcessor
{
    ...
    public async Task CreateUpcomingFixtureBy(CancellationToken token)
    {
        ...
        var leagues = new[]
        {
            ...
            new { League = League.PL, MatchDay = 24 },
            new { League = League.PD, MatchDay = 22 },
            new { League = League.SA, MatchDay = 23 },
            new { League = League.ELC, MatchDay = 33 },
            new { League = League.FL1, MatchDay = 24 },
        };
